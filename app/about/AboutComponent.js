                ...
                <div className={classes.about}>
                    ...
                    >
                        ...
                        <p className={classes.story_paragraphs}>
                            I’m a UX-focused software engineer and designer who builds web applications and digital platforms that are intuitive, accessible, and impactful. Over the past decade, I’ve designed and developed full-stack solutions for organizations in higher education, civic engagement, arts, publishing, and emerging technology—often from the ground up.<br /><br />
                            My work blends thoughtful UX design, strong technical implementation, and a creative problem-solving approach shaped by my background in art and design. Whether I’m prototyping interfaces, architecting user flows, or coding front-end components, I’m driven by the same goal: to create digital experiences that help people accomplish what matters to them, simply and enjoyably.<br /><br />
                            After designing and engineering the platform for Infinite Mile, an award-winning arts and culture journal in Detroit, I deepened my focus in UX design and software development. I later launched Public Arts Commission, a nonprofit that builds tools for civic and creative communities, and currently serve as the Founding Director of Art in Tech Services, where I lead the creation of custom, user-centered web applications.
                        </p>
